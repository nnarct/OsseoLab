      ...
      {data ? (
        <>
          ...
          >
            ...
            <Form.Item label='Case Code' name='case_code'>
              <Input placeholder={'Enter case code'} allowClear disabled style={{ color: 'black' }} />
            </Form.Item>
